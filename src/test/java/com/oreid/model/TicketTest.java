...
class TicketTest {
    ...
    private static final String EXPECTED_RELATED_DESCRIPTION_KEY = "subject";
    private static final EntityType EXPECTED_ENTITY_TYPE = EntityType.TICKET;

    private Ticket testee;

    @BeforeEach
    void setUp() {
        testee = new Ticket(JSON_OBJECT);
    }
    ...
    void testee_addRelatedEntity_single_success() {
        ...
        final var relatedEntity = new Ticket(JSON_OBJECT);
    ...
    void testee_addRelatedEntity_multiple_success() {
        ...
        final var relatedEntity1 = new Ticket(JSON_OBJECT);
        final var relatedEntity2 = new Ticket(JSON_OBJECT);
